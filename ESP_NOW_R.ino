...
struct_message_r incomingReadings1;
;
...
void loop() {
  ...
  Serial.println();
  Serial.printf("The data read from PIR in node 2 is : %d",PIR.x);
  Serial.println();
  // Send message via ESP-NOW
   esp_err_t result1 = esp_now_send(broadcastAddress2, (uint8_t *) &PIR, sizeof(struct_message));
    ...
    esp_err_t result2 = esp_now_send(broadcastAddress1, (uint8_t *) &PIR, sizeof(struct_message));
